...
namespace Game.LevelDesign
{
    ...
    public class ObjectDefinitionPreview : MonoBehaviour
    {
        ...
        private void UpdatePreview()
        {
            ...
            var spineComponentDefinition = objectDefinition.GetComponent<SpineComponentDefinition>();
            
            if (modelComponentDefinition != null && animationComponentDefinition != null && spineComponentDefinition == null
            ...
            if (modelComponentDefinition != null && spineComponentDefinition != null)
            {
                if (modelComponentDefinition.prefab != null && spineComponentDefinition.skeletonDataAsset != null)
                {
                    var skeletonAnimation = previewObject.GetComponentInChildren<SkeletonAnimation>();
                    skeletonAnimation.skeletonDataAsset = spineComponentDefinition.skeletonDataAsset;
                    
                    if (!string.IsNullOrEmpty(spineComponentDefinition.initialSkin) && skeletonAnimation.skeleton != null)
                    {
                        skeletonAnimation.skeleton.SetSkin(spineComponentDefinition.initialSkin);
                    }
                }
            } 
        }
