...
namespace Game.Systems
{
    public class PlayerInputSystem : BaseSystem, IEcsRunSystem
    {
        ...
        readonly EcsFilterInject<Inc<InputComponent, BufferedInputComponent>> controlsFilter = default;
        ...
        public void Run(EcsSystems systems)
        {
            foreach (var entity in playerInputFilter.Value)
            {
                ...
                playerInputComponent.inputActions = new Dictionary<string, InputAction>(StringComparer.OrdinalIgnoreCase);
            ...
            foreach (var entity in bufferInputFilter.Value)
            {
                ...
                bufferedInput.currentBufferTime -= Time.deltaTime;
            }
            ...
            foreach (var entity in controlsFilter.Value)
            {
                ...
                ref var bufferedInputComponent = ref controlsFilter.Pools.Inc2.Get(entity);
